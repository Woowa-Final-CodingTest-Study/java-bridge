...
public class OutputView {
    ...
    private String createBridgeMap(List<BridgeEnum> bridgeLocations, String location) {
        ...
        for (BridgeEnum bridgeLocation : bridgeLocations) {
            bridge.append(bridgeLocation.getStateLocation(location));
            bridge.append(DELIMITER);
        }
        return String.format(JOIN_LIST_FORMAT, bridge.toString());
    }
